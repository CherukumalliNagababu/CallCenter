...
public class Cab_Daily_Reports {
	...
	public void Cabs_Daily_Booking_Status_Reports() throws Exception {
		CabsBooking_Status.AllStatus_cabs_EG(iTestCaseRow, driver);
		Html_Report.GenerateMail_Report(iTestCaseRow, driver);
	}
