...
public class Hotels_Yesterday_Last_Month {
	...
	public void Hotels_Yesterday_Lastmonth_Booking_Status_Report() throws Exception
	{
	...
	*/
	...
	//Mail sent
		...
		//Date And Time
			...
			email.setSubject("Yesterday :(Date:"+Utils.Yesterdaytimestamp()+")-  Hotel Booking Status Report - "+Utils.YesterdayName());
