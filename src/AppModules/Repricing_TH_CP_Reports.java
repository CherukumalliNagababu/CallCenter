...
public class Repricing_TH_CP_Reports {
	...
	static List<String> Com_TH_Bookingid;
	static List<String> SA_TH_Bookingid;
	static List<String> AE_TH_Bookingid;
	static List<String> EG_TH_Bookingid;
	...
	static int Com_CP_F_Wego;
	static int Com_CP_F_b2c;
	static int Com_CP_F_MobIos;
	static int Com_CP_F_MobAnd;
	static int Com_CP_F_skyscan;
	static int Com_CP_F_Dhrehlat;
	static int Com_CP_F_Aviasa;
	static int Com_CP_F_Kayak;
	static int Com_CP_F_Dohop;
	static int Com_CP_F_Farecompare;
	static int Com_CP_F_Shoogloo;
	...
	static int Com_CP_F_conformation_pending_Total;
	static int Com_CP_F_Other_conformation_pending;
	...
	static int SA_CP_F_Wego;
	static int SA_CP_F_b2c;
	static int SA_CP_F_MobIos;
	static int SA_CP_F_MobAnd;
	static int SA_CP_F_skyscan;
	static int SA_CP_F_Dhrehlat;
	static int SA_CP_F_Aviasa;
	static int SA_CP_F_Kayak;
	static int SA_CP_F_Dohop;
	static int SA_CP_F_Farecompare;
	static int SA_CP_F_Shoogloo;

	static int SA_CP_conformation_pending_Total;
	static int SA_CP_Other_conformation_pending;
	static int SA_CP_F_conformation_pending_Total;
	static int SA_CP_F_Other_conformation_pending;
	...
	static int AE_CP_F_Wego;
	static int AE_CP_F_b2c;
	static int AE_CP_F_MobIos;
	static int AE_CP_F_MobAnd;
	static int AE_CP_F_skyscan;
	static int AE_CP_F_Dhrehlat;
	static int AE_CP_F_Aviasa;
	static int AE_CP_F_Kayak;
	static int AE_CP_F_Dohop;
	static int AE_CP_F_Farecompare;
	static int AE_CP_F_Shoogloo;

	static int AE_CP_conformation_pending_Total;
	static int AE_CP_Other_conformation_pending;
	static int AE_CP_F_conformation_pending_Total;
	static int AE_CP_F_Other_conformation_pending;
	...
	static int EG_CP_F_Wego;
	static int EG_CP_F_b2c;
	static int EG_CP_F_MobIos;
	static int EG_CP_F_MobAnd;
	static int EG_CP_F_skyscan;
	static int EG_CP_F_Dhrehlat;
	static int EG_CP_F_Aviasa;
	static int EG_CP_F_Kayak;
	static int EG_CP_F_Dohop;
	static int EG_CP_F_Farecompare;
	static int EG_CP_F_Shoogloo;

	static int EG_CP_conformation_pending_Total;
	static int EG_CP_Other_conformation_pending;
	static int EG_CP_F_conformation_pending_Total;
	static int EG_CP_F_Other_conformation_pending;
	...
	public static void Repricing_com(int iTestCaseRow, WebDriver driver) throws Exception {
		...
		System.out.println("Split the yesterday Date::" + spliteddate2[0]);
		...
		String st=dateFormat.format(currentdate);
		String[] spliteddate = st.split("-");
		System.out.println("Split the current Date::"+spliteddate[0]);
	  ...
	  String actualdate=spliteddate3[2];
		...
		if ("11".equals("1")) {
			...
			Loginpage.Select_activateDate(spliteddate[0]);
			Thread.sleep(1000);
		}
		else if("12".equals("2"))
		{
...
{
	Loginpage.Select_dateFrom(spliteddate2[0]);
	System.out.println("D:Select From Date:"+spliteddate2[0]);
	Thread.sleep(1000);
	Loginpage.ToDate().click();
	Thread.sleep(1000);
	 //Loginpage.Month_back().click();
	 Thread.sleep(1000);
	Loginpage.Select_activateDate(spliteddate[0]);
	System.out.println("D:Select activate To Date:"+spliteddate[0]);
	Thread.sleep(1000);
}
...
//Get booking id's
			...
			//List<WebElement> bookingId = driver.findElements(By.xpath(".//*[@id='searchresults']/div/div[2]/table/tbody/tr/td[1]"));
			  ...
			  Com_TH_Bookingid=values;
			
			System.out.println("COM Total Number of TH booking id's:" + values);
    	}
    	else
    	{
    	...
    	// ******************* confirmation
    			// pending--Fail*********************************************
    			Select conpending1 = new Select(Loginpage.BookingSatus());
    			conpending1.selectByIndex(4);
    			Thread.sleep(2000);
    			Select paymentStatus = new Select(Loginpage.PaymentStatus());
    			paymentStatus.selectByIndex(2);
    			Thread.sleep(2000);
    			Loginpage.Search_button().click();
    			Thread.sleep(1000);

    			String conpendingcount1 = Loginpage.FlightResults_text().getText();
    			System.out.println(conpendingcount1);

    			String comconpendingstr1 = conpendingcount1.trim();
    			String[] comconpendingplited1 = comconpendingstr1.split("\\:");
    			System.out.println("No of Results Count" + comconpendingplited1[1]);
    			Thread.sleep(1000);
    			String conformation_pending1 = "Confirmation Pending";

    			if ("Flight Search Results : 0".equals(conpendingcount1)) {
    				...
    				Com_CP_F_Dohop = 0;
    				Com_CP_F_Farecompare = 0;
    				Com_CP_F_Shoogloo = 0;

    				int TotalValue = Com_CP_F_Wego + Com_CP_F_b2c + Com_CP_F_MobIos + Com_CP_F_skyscan + Com_CP_F_MobAnd + Com_CP_F_Dhrehlat
    						+ Com_CP_F_Aviasa + Com_CP_F_Kayak + Com_CP_F_Dohop + Com_CP_F_Farecompare + Com_CP_F_Shoogloo;

    				Com_CP_F_conformation_pending_Total = TotalValue;
    				System.out.println("Confirmation Pending total:::----" + Com_CP_F_conformation_pending_Total);

    				int Other = Com_CP_F_Dhrehlat + Com_CP_F_Aviasa + Com_CP_F_Kayak + Com_CP_F_Dohop + Com_CP_F_Farecompare
    						+ Com_CP_F_Shoogloo;

    				Com_CP_F_Other_conformation_pending = Other;
    				System.out
    						.println(" Others domains Confirmation Pending total :::----" + Com_CP_F_Other_conformation_pending);
    					...
    					for (int j = 0; j < unique.size(); j++) {
    						...
    						case "WEGO":
    							if (element.equals("WEGO")) {
    								...
    								Com_CP_F_Wego = Integer.parseInt(Com_TS_Wego1);
    						...
    						case "B2C":
    							...
    							if (element.equals("B2C")) {
    								...
    								Com_CP_F_b2c = Integer.parseInt(Com_TS_b2c1);
    							} else {
    								String Com_TS_b2c1 = String.format("%1s", 0);
    						...
    						case "MOBIOS":
    							if (element.equals("MOBIOS")) {
    								...
    								Com_CP_F_MobIos = Integer.parseInt(Com_TS_MobIos1);
    							} else {
    								String Com_TS_MobIos1 = String.format("%1s", 0);
    						...
    						case "MOBAPP":
    							if (element.equals("MOBAPP")) {
    								...
    								Com_CP_F_MobAnd = Integer.parseInt(Com_TS_MobAnd1);
    							} else {
    								String Com_TS_MobAnd1 = String.format("%1s", 0);
    						...
    						case "SKYSCN":
    							if (element.equals("SKYSCN")) {
    								...
    								Com_CP_F_skyscan = Integer.parseInt(Com_TS_skyscan1);
    							} else {
    								String Com_TS_skyscan1 = String.format("%1s", 0);
    						...
    						case "DHREHLAT":
    							if (element.equals("DHREHLAT")) {
    								...
    								Com_CP_F_Dhrehlat = Integer.parseInt(Com_TS_Dhrehlat1);
    							} else {
    								String Com_TS_Dhrehlat1 = String.format("%1s", 0);
    						...
    						case "AVIASALES":
    							if (element.equals("AVIASALES")) {
    								...
    								Com_CP_F_Aviasa = Integer.parseInt(Com_TS_Aviasa1);
    						...
    						case "KAYAK":
    							if (element.equals("KAYAK")) {
    								...
    								Com_CP_F_Kayak = Integer.parseInt(Com_TS_Kayak1);
    							}
    						...
    						case "DOHOP":
    							if (element.equals("DOHOP")) {
    								...
    								Com_CP_F_Dohop = Integer.parseInt(Com_TS_Dohop1);
    							} else {
    								String Com_TS_Dohop1 = String.format("%1s", 0);
    						...
    						case "FARECOMPARE":
    							...
    							if (element.equals("FARECOMPARE")) {
    								...
    								Com_CP_F_Farecompare = Integer.parseInt(Com_TS_Farecompare1);
    							} else {
    						...
    						case "SHOOGLOO":
    							if (element.equals("SHOOGLOO")) {
    								...
    								Com_CP_F_Shoogloo = Integer.parseInt(Com_TS_Shoogloo1);
	...
	public static void Repricing_SA(int iTestCaseRow, WebDriver driver) throws Exception {
		...
		if ("11".equals("1")) {
			...
			Thread.sleep(1000);
			//Loginpage.Month_back().click();
			Loginpage.Select_activateDate(SAspliteddate[0]);
			Thread.sleep(1000);
		}
		else if("12".equals("2"))
		{
...
//Get booking id's
				...
				int Other =SA_TH_Dhrehlat + SA_TH_Aviasa +SA_TH_Kayak + SA_TH_Dohop+ SA_TH_Farecompare+SA_TH_Shoogloo ;
					...
					SA_TH_Other_TransactionholdTotal =  Other; 
	 				...
	 				//List<WebElement> bookingId = driver.findElements(By.xpath(".//*[@id='searchresults']/div/div[2]/table/tbody/tr/td[1]"));
	 				 ...
	 				 values.add("0");
	 				  SA_TH_Bookingid=values;
	 				
	 				System.out.println("SA Total Number of TH booking id's:" + values);
		...
		if ("Flight Search Results : 0".equals(conpendingcount1)) {
			...
			SA_CP_F_Dohop = 0;
			SA_CP_F_Farecompare = 0;
			SA_CP_F_Shoogloo = 0;

			int TotalValue = SA_CP_F_Wego + SA_CP_F_b2c + SA_CP_F_MobIos + SA_CP_F_skyscan + SA_CP_F_MobAnd + SA_CP_F_Dhrehlat
					+ SA_CP_F_Aviasa + SA_CP_F_Kayak + SA_CP_F_Dohop + SA_CP_F_Farecompare + SA_CP_F_Shoogloo;

			SA_CP_F_conformation_pending_Total = TotalValue;
			System.out.println("Confirmation Pending total:::----" + SA_CP_F_conformation_pending_Total);

			int Other = SA_CP_F_Dhrehlat + SA_CP_F_Aviasa + SA_CP_F_Kayak + SA_CP_F_Dohop + SA_CP_F_Farecompare + SA_CP_F_Shoogloo;

			SA_CP_F_Other_conformation_pending = Other;
			System.out.println(" Others domains Confirmation Pending total :::----" + SA_CP_F_Other_conformation_pending);
				...
				for (int j = 0; j < unique.size(); j++) {
					...
					case "WEGO":
						if (element.equals("WEGO")) {
							...
							SA_CP_F_Wego = Integer.parseInt(Com_TS_Wego1);
					...
					case "B2C":
						...
						if (element.equals("B2C")) {
							...
							SA_CP_F_b2c = Integer.parseInt(Com_TS_b2c1);
						} else {
							String Com_TS_b2c1 = String.format("%1s", 0);
					...
					case "MOBIOS":
						if (element.equals("MOBIOS")) {
							...
							SA_CP_F_MobIos = Integer.parseInt(Com_TS_MobIos1);
						} else {
							String Com_TS_MobIos1 = String.format("%1s", 0);
					...
					case "MOBAPP":
						if (element.equals("MOBAPP")) {
							...
							SA_CP_F_MobAnd = Integer.parseInt(Com_TS_MobAnd1);
						} else {
							String Com_TS_MobAnd1 = String.format("%1s", 0);
					...
					case "SKYSCN":
						if (element.equals("SKYSCN")) {
							...
							SA_CP_F_skyscan = Integer.parseInt(Com_TS_skyscan1);
						} else {
							String Com_TS_skyscan1 = String.format("%1s", 0);
					...
					case "DHREHLAT":
						if (element.equals("DHREHLAT")) {
							...
							SA_CP_F_Dhrehlat = Integer.parseInt(Com_TS_Dhrehlat1);
						} else {
							String Com_TS_Dhrehlat1 = String.format("%1s", 0);
					...
					case "AVIASALES":
						if (element.equals("AVIASALES")) {
							...
							SA_CP_F_Aviasa = Integer.parseInt(Com_TS_Aviasa1);
					...
					case "KAYAK":
						if (element.equals("KAYAK")) {
							...
							SA_CP_F_Kayak = Integer.parseInt(Com_TS_Kayak1);
						}
					...
					case "DOHOP":
						if (element.equals("DOHOP")) {
							...
							SA_CP_F_Dohop = Integer.parseInt(Com_TS_Dohop1);
						} else {
							String Com_TS_Dohop1 = String.format("%1s", 0);
					...
					case "FARECOMPARE":
						...
						if (element.equals("FARECOMPARE")) {
							...
							SA_CP_F_Farecompare = Integer.parseInt(Com_TS_Farecompare1);
						} else {
					...
					case "SHOOGLOO":
						if (element.equals("SHOOGLOO")) {
							...
							SA_CP_F_Shoogloo = Integer.parseInt(Com_TS_Shoogloo1);
	...
	public static void Repricing_AE(int iTestCaseRow, WebDriver driver) throws Exception {
		...
		if ("11".equals("1")) {
			...
			Thread.sleep(1000);
			//Loginpage.Month_back().click();
			Loginpage.Select_activateDate(AEspliteddate[0]);
			Thread.sleep(1000);
		}
		else if("12".equals("2"))
		{
...
//Get booking id's
	 				...
	 				//  for (WebElement e : bookingId)
	 				  ...
	 				  AE_TH_Bookingid=values;
	 				
	 				System.out.println("AE Total Number of TH booking id's:" + values);
    	}
    	else
    	{
    	...
    	// ******************* confirmation
    			...
    			if ("Flight Search Results : 0".equals(conpendingcount1)) {
    				...
    				AE_CP_F_Dohop = 0;
    				AE_CP_F_Farecompare = 0;
    				AE_CP_F_Shoogloo = 0;

    				int TotalValue = AE_CP_F_Wego + AE_CP_F_b2c + AE_CP_F_MobIos + AE_CP_F_skyscan + AE_CP_F_MobAnd + AE_CP_F_Dhrehlat
    						+ AE_CP_F_Aviasa + AE_CP_F_Kayak + AE_CP_F_Dohop + AE_CP_F_Farecompare + AE_CP_F_Shoogloo;

    				AE_CP_F_conformation_pending_Total = TotalValue;
    				System.out.println("Confirmation Pending total:::----" + AE_CP_F_conformation_pending_Total);

    				int Other = AE_CP_F_Dhrehlat + AE_CP_F_Aviasa + AE_CP_F_Kayak + AE_CP_F_Dohop + AE_CP_F_Farecompare + AE_CP_F_Shoogloo;

    				AE_CP_F_Other_conformation_pending = Other;
    				System.out.println(" Others domains Confirmation Pending total :::----" + AE_CP_F_Other_conformation_pending);
    					...
    					for (int j = 0; j < unique.size(); j++) {
    						...
    						case "WEGO":
    							if (element.equals("WEGO")) {
    								...
    								AE_CP_F_Wego = Integer.parseInt(Com_TS_Wego1);
    						...
    						case "B2C":
    							...
    							if (element.equals("B2C")) {
    								...
    								AE_CP_F_b2c = Integer.parseInt(Com_TS_b2c1);
    							} else {
    								String Com_TS_b2c1 = String.format("%1s", 0);
    						...
    						case "MOBIOS":
    							if (element.equals("MOBIOS")) {
    								...
    								AE_CP_F_MobIos = Integer.parseInt(Com_TS_MobIos1);
    							} else {
    								String Com_TS_MobIos1 = String.format("%1s", 0);
    						...
    						case "MOBAPP":
    							if (element.equals("MOBAPP")) {
    								...
    								AE_CP_F_MobAnd = Integer.parseInt(Com_TS_MobAnd1);
    							} else {
    								String Com_TS_MobAnd1 = String.format("%1s", 0);
    						...
    						case "SKYSCN":
    							if (element.equals("SKYSCN")) {
    								...
    								AE_CP_F_skyscan = Integer.parseInt(Com_TS_skyscan1);
    							} else {
    								String Com_TS_skyscan1 = String.format("%1s", 0);
    						...
    						case "DHREHLAT":
    							if (element.equals("DHREHLAT")) {
    								...
    								AE_CP_F_Dhrehlat = Integer.parseInt(Com_TS_Dhrehlat1);
    							} else {
    								String Com_TS_Dhrehlat1 = String.format("%1s", 0);
    						...
    						case "AVIASALES":
    							if (element.equals("AVIASALES")) {
    								...
    								AE_CP_F_Aviasa = Integer.parseInt(Com_TS_Aviasa1);
    						...
    						case "KAYAK":
    							if (element.equals("KAYAK")) {
    								...
    								AE_CP_F_Kayak = Integer.parseInt(Com_TS_Kayak1);
    							}
    						...
    						case "DOHOP":
    							if (element.equals("DOHOP")) {
    								...
    								AE_CP_F_Dohop = Integer.parseInt(Com_TS_Dohop1);
    							} else {
    								String Com_TS_Dohop1 = String.format("%1s", 0);
    						...
    						case "FARECOMPARE":
    							...
    							if (element.equals("FARECOMPARE")) {
    								...
    								AE_CP_F_Farecompare = Integer.parseInt(Com_TS_Farecompare1);
    							} else {
    						...
    						case "SHOOGLOO":
    							if (element.equals("SHOOGLOO")) {
    								...
    								AE_CP_F_Shoogloo = Integer.parseInt(Com_TS_Shoogloo1);
	...
	public static void Repricing_EG(int iTestCaseRow, WebDriver driver) throws Exception {
		...
		if ("11".equals("1")) {
			...
			Thread.sleep(1000);
			//Loginpage.Month_back().click();
			Loginpage.Select_activateDate(EGspliteddate[0]);
			Thread.sleep(1000);
		}
		else if("12".equals("2"))
		{
...
//Get booking id's
	    	...
	    	int TotalValue =  EG_TH_Wego  +  EG_TH_b2c  + EG_TH_MobIos  +  EG_TH_MobAnd +  EG_TH_skyscan 
				...
				EG_TH_Other_TransactionHoldTotal =  Other; 
 				...
 				//List<WebElement> bookingId = driver.findElements(By.xpath(".//*[@id='searchresults']/div/div[2]/table/tbody/tr/td[1]"));
 				  ...
 				  EG_TH_Bookingid=values;
 				
 				System.out.println("EG Total Number of TH booking id's:" + values);
    	}
    	else
    	{
    	...
    	// ******************* confirmation
    			...
    			if ("Flight Search Results : 0".equals(conpendingcount1)) {
    				...
    				EG_CP_F_Dohop = 0;
    				EG_CP_F_Farecompare = 0;
    				EG_CP_F_Shoogloo = 0;

    				int TotalValue = EG_CP_F_Wego + EG_CP_F_b2c + EG_CP_F_MobIos + EG_CP_F_skyscan + EG_CP_F_MobAnd + EG_CP_F_Dhrehlat
    						+ EG_CP_F_Aviasa + EG_CP_F_Kayak + EG_CP_F_Dohop + EG_CP_F_Farecompare + EG_CP_F_Shoogloo;

    				EG_CP_F_conformation_pending_Total = TotalValue;
    				System.out.println("Confirmation Pending total:::----" + EG_CP_F_conformation_pending_Total);

    				int Other = EG_CP_F_Dhrehlat + EG_CP_F_Aviasa + EG_CP_F_Kayak + EG_CP_F_Dohop + EG_CP_F_Farecompare + EG_CP_F_Shoogloo;

    				EG_CP_F_Other_conformation_pending = Other;
    				System.out.println(" Others domains Confirmation Pending total :::----" + EG_CP_F_Other_conformation_pending);
    					...
    					for (int j = 0; j < unique.size(); j++) {
    						...
    						case "WEGO":
    							if (element.equals("WEGO")) {
    								...
    								EG_CP_F_Wego = Integer.parseInt(Com_TS_Wego1);
    						...
    						case "B2C":
    							...
    							if (element.equals("B2C")) {
    								...
    								EG_CP_F_b2c = Integer.parseInt(Com_TS_b2c1);
    							} else {
    								String Com_TS_b2c1 = String.format("%1s", 0);
    						...
    						case "MOBIOS":
    							if (element.equals("MOBIOS")) {
    								...
    								EG_CP_F_MobIos = Integer.parseInt(Com_TS_MobIos1);
    							} else {
    								String Com_TS_MobIos1 = String.format("%1s", 0);
    						...
    						case "MOBAPP":
    							if (element.equals("MOBAPP")) {
    								...
    								EG_CP_F_MobAnd = Integer.parseInt(Com_TS_MobAnd1);
    							} else {
    								String Com_TS_MobAnd1 = String.format("%1s", 0);
    						...
    						case "SKYSCN":
    							if (element.equals("SKYSCN")) {
    								...
    								EG_CP_F_skyscan = Integer.parseInt(Com_TS_skyscan1);
    							} else {
    								String Com_TS_skyscan1 = String.format("%1s", 0);
    						...
    						case "DHREHLAT":
    							if (element.equals("DHREHLAT")) {
    								...
    								EG_CP_F_Dhrehlat = Integer.parseInt(Com_TS_Dhrehlat1);
    							} else {
    								String Com_TS_Dhrehlat1 = String.format("%1s", 0);
    						...
    						case "AVIASALES":
    							if (element.equals("AVIASALES")) {
    								...
    								EG_CP_F_Aviasa = Integer.parseInt(Com_TS_Aviasa1);
    						...
    						case "KAYAK":
    							if (element.equals("KAYAK")) {
    								...
    								EG_CP_F_Kayak = Integer.parseInt(Com_TS_Kayak1);
    							}
    						...
    						case "DOHOP":
    							if (element.equals("DOHOP")) {
    								...
    								EG_CP_F_Dohop = Integer.parseInt(Com_TS_Dohop1);
    							} else {
    								String Com_TS_Dohop1 = String.format("%1s", 0);
    						...
    						case "FARECOMPARE":
    							...
    							if (element.equals("FARECOMPARE")) {
    								...
    								EG_CP_F_Farecompare = Integer.parseInt(Com_TS_Farecompare1);
    							} else {
    						...
    						case "SHOOGLOO":
    							if (element.equals("SHOOGLOO")) {
    								...
    								EG_CP_F_Shoogloo = Integer.parseInt(Com_TS_Shoogloo1);
