...
public class Flights_Yesterday_Supplier_Mail extends Flight_Yesterday_Supplier_Bookings {
...
public static void getValues_new() throws IOException, RowsExceededException, WriteException
{
   ...
   System.out.println("Year"+values[2]); 
	...
	FileOutputStream fo = new FileOutputStream("C:/NewReports/"+values[2]+"/"+values[1]+"/"+LDate1+"/Report_Yesterday.xls");
	wwb = Workbook.createWorkbook(fo);
	ws = wwb.createSheet("Results", 0);
