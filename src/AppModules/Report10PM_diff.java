...
public class Report10PM_diff extends differentPageReports {
	...
	static String R4_toDayDate;
	static String R4_toDayDate1;
	static String R4_toDayDate2;
	static String R4_toDayDate3;
	static String R4_toDayDate4;
	static String R4_toDayDate5;
	static String R4_toDayDate6;
	
	static String R4_First2_y;
	static String R4_First3_y;
	static String R4_First4_y;
	static String R4_First5_y;
	static String R4_First6_y;
	static String R4_First7_y;
	
	static String R4_First1;
	static String R4_First2;
	static String R4_First3;
	static String R4_First4;
	static String R4_First5;
	static String R4_First6;
	static String R4_First7;
	
	static String R4_Second1;
	static String R4_Second2;
	static String R4_Second3;
	static String R4_Second4;
	static String R4_Second5;
	static String R4_Second6;
	static String R4_Second7;
	
	
	static String R6_toDayDate;
	static String R6_toDayDate1;
	static String R6_toDayDate2;
	static String R6_toDayDate3;
	static String R6_toDayDate4;
	static String R6_toDayDate5;
	static String R6_toDayDate6;
	
	static String R6_First2_y;
	static String R6_First3_y;
	static String R6_First4_y;
	static String R6_First5_y;
	static String R6_First6_y;
	static String R6_First7_y;
	
	static String R6_First1;
	static String R6_First2;
	static String R6_First3;
	static String R6_First4;
	static String R6_First5;
	static String R6_First6;
	static String R6_First7;
	
	static String R6_Second1;
	static String R6_Second2;
	static String R6_Second3;
	static String R6_Second4;
	static String R6_Second5;
	static String R6_Second6;
	static String R6_Second7;
	
	static String R8_toDayDate;
	static String R8_toDayDate1;
	static String R8_toDayDate2;
	static String R8_toDayDate3;
	static String R8_toDayDate4;
	static String R8_toDayDate5;
	static String R8_toDayDate6;
	
	static String R8_First2_y;
	static String R8_First3_y;
	static String R8_First4_y;
	static String R8_First5_y;
	static String R8_First6_y;
	static String R8_First7_y;
	
	static String R8_First1;
	static String R8_First2;
	static String R8_First3;
	static String R8_First4;
	static String R8_First5;
	static String R8_First6;
	static String R8_First7;
	
	static String R8_Second1;
	static String R8_Second2;
	static String R8_Second3;
	static String R8_Second4;
	static String R8_Second5;
	static String R8_Second6;
	static String R8_Second7;
	
	static String R10PM_toDayDate;
	static String R10PM_toDayDate1;
	static String R10PM_toDayDate2;
	static String R10PM_toDayDate3;
	static String R10PM_toDayDate4;
	static String R10PM_toDayDate5;
	static String R10PM_toDayDate6;
	
	static String R10PM_First2_y;
	static String R10PM_First3_y;
	static String R10PM_First4_y;
	static String R10PM_First5_y;
	static String R10PM_First6_y;
	static String R10PM_First7_y;
	
	static String R10PM_First1;
	static String R10PM_First2;
	static String R10PM_First3;
	static String R10PM_First4;
	static String R10PM_First5;
	static String R10PM_First6;
	static String R10PM_First7;
	
	static String R10PM_Second1;
	static String R10PM_Second2;
	static String R10PM_Second3;
	static String R10PM_Second4;
	static String R10PM_Second5;
	static String R10PM_Second6;
	static String R10PM_Second7;
	
	static String NA="00";
	public static void Report_10_30PM() throws Exception
	{
		
		//To day 10:30PM Report
				...
				R10PM_toDayDate = ToDay_10.replace("_", "-");
				System.out.println(R10PM_toDayDate);
				...
				System.out.println("C:/DailyXLReports/"+SD_10[2]+"/"+SD_10[1]+"/"+ToDay_10+"/Report_"+SD_10[0]+"_"+SD_10[1]+"_"+ SD_10[2]+" 10 PM.xls");
				
				System.out.println("naga");
				try{
					
				
				FileInputStream file1 = new FileInputStream("C:/DailyXLReports/"+SD_10[2]+"/"+SD_10[1]+"/"+ToDay_10+"/Report_"+SD_10[0]+"_"+ SD_10[1]+"_"+ SD_10[2]+" 10 PM.xls");
				Workbook wb1 = Workbook.getWorkbook(file1);
				Sheet sheet1 = wb1.getSheet("Results");
				R10PM_First1=sheet1.getCell(0, 1).getContents();
				R10PM_Second1=sheet1.getCell(0, 2).getContents();
				System.out.println(R10PM_First1);
				System.out.println(R10PM_Second1);
				}
				catch(Exception e){
		       ...
		       System.out.println("C:/DailyXLReports/"+SD[2]+"/"+SD[1]+"/"+LDate1+"/Report_"+SD[0]+"_"+SD[1]+"_"+ SD[2]+" 10 PM.xls");
				try{
		       FileInputStream file2 = new FileInputStream("C:/DailyXLReports/"+SD[2]+"/"+SD[1]+"/"+LDate1+"/Report_"+SD[0]+"_"+ SD[1]+"_"+ SD[2]+" 10 PM.xls");
				Workbook wb2 = Workbook.getWorkbook(file2);
				Sheet sheet2 = wb2.getSheet("Results");
				
				R10PM_First2=sheet2.getCell(0, 1).getContents();
				R10PM_Second2=sheet2.getCell(0, 2).getContents();
				System.out.println(R10PM_First2);
				System.out.println(R10PM_Second2);
				}
                catch(Exception e){
				...
				R10PM_First2_y=sheet2_y.getCell(0, 1).getContents();
				System.out.println(R10PM_First2_y);
				}
                 catch(Exception e){
                	 R10PM_First2_y=NA;
				...
				//2 weeks back 10:30PM Report
				       ...
				       R10PM_toDayDate2 = st1.replace("_", "-");
				       ...
				       System.out.println("C:/DailyXLReports/"+SD1[2]+"/"+SD1[1]+"/"+L_W_Date1+"/Report_"+SD1[0]+"_"+SD1[1]+"_"+ SD1[2]+" 10 PM.xls");
						try{
				       FileInputStream file3 = new FileInputStream("C:/DailyXLReports/"+SD1[2]+"/"+SD1[1]+"/"+L_W_Date1+"/Report_"+SD1[0]+"_"+ SD1[1]+"_"+ SD1[2]+" 10 PM.xls");
						Workbook wb3 = Workbook.getWorkbook(file3);
						Sheet sheet3 = wb3.getSheet("Results");
						
						R10PM_First3=sheet3.getCell(0, 1).getContents();
						R10PM_Second3=sheet3.getCell(0, 2).getContents();
						System.out.println(R10PM_First3);
						System.out.println(R10PM_Second3);
						}
						 catch(Exception e){
							 R10PM_First3=NA;
							 R10PM_Second3=NA;
						...
						R10PM_First3_y=sheet3_y.getCell(0, 1).getContents();
						System.out.println(R10PM_First3_y);
						}
	            	...
	            	R10PM_First3_y=NA;
				       ...
				       R10PM_toDayDate3 = st2.replace("_", "-");
				       ...
				       System.out.println("C:/DailyXLReports/"+SD2[2]+"/"+SD2[1]+"/"+L_W_Date2+"/Report_"+SD2[0]+"_"+SD2[1]+"_"+ SD2[2]+" 10 PM.xls");
						
				       try{
				    	 FileInputStream file4 = new FileInputStream("C:/DailyXLReports/"+SD2[2]+"/"+SD2[1]+"/"+L_W_Date2+"/Report_"+SD2[0]+"_"+ SD2[1]+"_"+ SD2[2]+" 10 PM.xls");
				       	Workbook wb4 = Workbook.getWorkbook(file4);
						Sheet sheet4 = wb4.getSheet("Results");
						R10PM_First4=sheet4.getCell(0, 1).getContents();
						R10PM_Second4=sheet4.getCell(0, 2).getContents();
						System.out.println(R10PM_First4);
						System.out.println(R10PM_Second4);
				       }
				       catch(Exception e){
				    	   R10PM_First4=NA;
				    	   R10PM_Second4=NA;
				       ...
				       try{
						...
						R10PM_First4_y=sheet4_y.getCell(0, 1).getContents();
						System.out.println(R10PM_First4_y);
				       }
				       catch(Exception e){
				    	   R10PM_First4_y=NA;
				       ...
				       R10PM_toDayDate4 = st3.replace("_", "-");
				       ...
				       System.out.println("C:/DailyXLReports/"+SD3[2]+"/"+SD3[1]+"/"+L_W_Date3+"/Report_"+SD3[0]+"_"+SD3[1]+"_"+ SD3[2]+" 10 PM.xls");
						try{
				       FileInputStream file5 = new FileInputStream("C:/DailyXLReports/"+SD3[2]+"/"+SD3[1]+"/"+L_W_Date3+"/Report_"+SD3[0]+"_"+ SD3[1]+"_"+ SD3[2]+" 10 PM.xls");
						Workbook wb5 = Workbook.getWorkbook(file5);
						Sheet sheet5 = wb5.getSheet("Results");
						R10PM_First5=sheet5.getCell(0, 1).getContents();
						R10PM_Second5=sheet5.getCell(0, 2).getContents();
						System.out.println(R10PM_First5);
						System.out.println(R10PM_Second5);
						}
						 catch(Exception e){
							 R10PM_First5=NA;
							 R10PM_Second5=NA;
						...
						R10PM_First5_y=sheet5_y.getCell(0, 1).getContents();
						System.out.println(R10PM_First5_y);
						} catch(Exception e){
							R10PM_First5_y=NA;
		    	            }
						
						//5 weeks back 10:30PM Report
				       ...
				       R10PM_toDayDate5 = st4.replace("_", "-");
				       ...
				       System.out.println("C:/DailyXLReports/"+SD4[2]+"/"+SD4[1]+"/"+L_W_Date4+"/Report_"+SD4[0]+"_"+SD4[1]+"_"+ SD4[2]+" 10 PM.xls");
						try{
				       FileInputStream file6 = new FileInputStream("C:/DailyXLReports/"+SD4[2]+"/"+SD4[1]+"/"+L_W_Date4+"/Report_"+SD4[0]+"_"+ SD4[1]+"_"+ SD4[2]+" 10 PM.xls");
						Workbook wb6 = Workbook.getWorkbook(file6);
						Sheet sheet6 = wb6.getSheet("Results");
						R10PM_First6=sheet6.getCell(0, 1).getContents();
						R10PM_Second6=sheet6.getCell(0, 2).getContents();
						System.out.println(R10PM_First6);
						System.out.println(R10PM_Second6);
						}catch(Exception e){
							R10PM_First6=NA;
							R10PM_Second6=NA;
	    	            }
						...
						R10PM_First6_y=sheet6_y.getCell(0, 1).getContents();
						System.out.println(R10PM_First6_y);
						}
						catch(Exception e){
							R10PM_First6_y=NA;
							  }
						
						//6 weeks back 10:30PM Report
				       ...
				       R10PM_toDayDate6 = st5.replace("_", "-");
				       ...
				       System.out.println("C:/DailyXLReports/"+SD5[2]+"/"+SD5[1]+"/"+L_W_Date5+"/Report_"+SD5[0]+"_"+SD5[1]+"_"+ SD5[2]+" 10 PM.xls");
						try{
				       FileInputStream file7 = new FileInputStream("C:/DailyXLReports/"+SD5[2]+"/"+SD5[1]+"/"+L_W_Date5+"/Report_"+SD5[0]+"_"+ SD5[1]+"_"+ SD5[2]+" 10 PM.xls");
						Workbook wb7 = Workbook.getWorkbook(file7);
						Sheet sheet7 = wb7.getSheet("Results");
						R10PM_First7=sheet7.getCell(0, 1).getContents();
						R10PM_Second7=sheet7.getCell(0, 2).getContents();
						System.out.println(R10PM_First7);
						System.out.println(R10PM_Second7);
						}
						catch(Exception e){
							R10PM_First7=NA;
							R10PM_Second7=NA;
						...
						R10PM_First7_y=sheet7_y.getCell(0, 1).getContents();
						System.out.println(R10PM_First7_y);
						}
						catch(Exception e){
							R10PM_First7_y=NA;
	...
	public static void Report_8_30PM() throws Exception
	{
		
		//To day 8:30PM Report
				DateFormat Formate_10 = new SimpleDateFormat("dd_MMM_yyyy");
				Date d_10 = new Date();
				System.out.println(Formate_10.format(d_10));
				String ToDay_10 = Formate_10.format(d_10);
				R8_toDayDate = ToDay_10.replace("_", "-");
				System.out.println(R8_toDayDate);
				String[] SD_10 = ToDay_10.split("_");
				System.out.println("Split the Date::" + SD_10[0]);
				System.out.println("Split the month::" + SD_10[1]);
				System.out.println("Split the Year::" + SD_10[2]);
				System.out.println("C:/DailyXLReports/"+SD_10[2]+"/"+SD_10[1]+"/"+ToDay_10+"/Report_"+SD_10[0]+"_"+SD_10[1]+"_"+ SD_10[2]+" 08 PM.xls");
				
				System.out.println("naga");
				try{
					
				
				FileInputStream file1 = new FileInputStream("C:/DailyXLReports/"+SD_10[2]+"/"+SD_10[1]+"/"+ToDay_10+"/Report_"+SD_10[0]+"_"+ SD_10[1]+"_"+ SD_10[2]+" 08 PM.xls");
				Workbook wb1 = Workbook.getWorkbook(file1);
				Sheet sheet1 = wb1.getSheet("Results");
				R8_First1=sheet1.getCell(0, 1).getContents();
				R8_Second1=sheet1.getCell(0, 2).getContents();
				System.out.println(R8_First1);
				System.out.println(R8_Second1);
				}
				catch(Exception e){
		       ...
		       System.out.println("lastDates  is "+LDate1);
		       System.out.println("C:/DailyXLReports/"+SD[2]+"/"+SD[1]+"/"+LDate1+"/Report_"+SD[0]+"_"+SD[1]+"_"+ SD[2]+" 08 PM.xls");
				try{
		       FileInputStream file2 = new FileInputStream("C:/DailyXLReports/"+SD[2]+"/"+SD[1]+"/"+LDate1+"/Report_"+SD[0]+"_"+ SD[1]+"_"+ SD[2]+" 08 PM.xls");
				Workbook wb2 = Workbook.getWorkbook(file2);
				Sheet sheet2 = wb2.getSheet("Results");
				
				R8_First2=sheet2.getCell(0, 1).getContents();
				R8_Second2=sheet2.getCell(0, 2).getContents();
				System.out.println(R8_First2);
				System.out.println(R8_Second2);
				}
                catch(Exception e){
				...
				Workbook wb2_y = Workbook.getWorkbook(file2_y);
				Sheet sheet2_y = wb2_y.getSheet("Results");
				R8_First2_y=sheet2_y.getCell(0, 1).getContents();
				System.out.println(R8_First2_y);
				}
                 catch(Exception e){
                	 R8_First2_y=NA;
				...
				//2 weeks back 8:30PM Report
				       ...
				       System.out.println("lastDates  is "+L_W_Date1);
				       System.out.println("C:/DailyXLReports/"+SD1[2]+"/"+SD1[1]+"/"+L_W_Date1+"/Report_"+SD1[0]+"_"+SD1[1]+"_"+ SD1[2]+" 08 PM.xls");
						try{
				       FileInputStream file3 = new FileInputStream("C:/DailyXLReports/"+SD1[2]+"/"+SD1[1]+"/"+L_W_Date1+"/Report_"+SD1[0]+"_"+ SD1[1]+"_"+ SD1[2]+" 08 PM.xls");
						Workbook wb3 = Workbook.getWorkbook(file3);
						Sheet sheet3 = wb3.getSheet("Results");
						
						R8_First3=sheet3.getCell(0, 1).getContents();
						R8_Second3=sheet3.getCell(0, 2).getContents();
						System.out.println(R8_First3);
						System.out.println(R8_Second3);
						}
						 catch(Exception e){
							 R8_First3=NA;
							 R8_Second3=NA;
						...
						Workbook wb3_y = Workbook.getWorkbook(file3_y);
						Sheet sheet3_y = wb3_y.getSheet("Results");
						R8_First3_y=sheet3_y.getCell(0, 1).getContents();
						System.out.println(R8_First3_y);
						}
	            	...
	            	R8_First3_y=NA;
				       ...
				       System.out.println("lastDates  is "+L_W_Date2);
				       System.out.println("C:/DailyXLReports/"+SD2[2]+"/"+SD2[1]+"/"+L_W_Date2+"/Report_"+SD2[0]+"_"+SD2[1]+"_"+ SD2[2]+" 08 PM.xls");
						
				       try{
				    	 FileInputStream file4 = new FileInputStream("C:/DailyXLReports/"+SD2[2]+"/"+SD2[1]+"/"+L_W_Date2+"/Report_"+SD2[0]+"_"+ SD2[1]+"_"+ SD2[2]+" 08 PM.xls");
				       	Workbook wb4 = Workbook.getWorkbook(file4);
						Sheet sheet4 = wb4.getSheet("Results");
						R8_First4=sheet4.getCell(0, 1).getContents();
						R8_Second4=sheet4.getCell(0, 2).getContents();
						System.out.println(R8_First4);
						System.out.println(R8_Second4);
				       }
				       catch(Exception e){
				    	   R8_First4=NA;
				    	   R8_Second4=NA;
				       ...
				       try{
						...
						Workbook wb4_y = Workbook.getWorkbook(file4_y);
						Sheet sheet4_y = wb4_y.getSheet("Results");
						R8_First4_y=sheet4_y.getCell(0, 1).getContents();
						System.out.println(R8_First4_y);
				       }
				       catch(Exception e){
				    	   R8_First4_y=NA;
				       ...
				       System.out.println("lastDates  is "+L_W_Date3);
				       System.out.println("C:/DailyXLReports/"+SD3[2]+"/"+SD3[1]+"/"+L_W_Date3+"/Report_"+SD3[0]+"_"+SD3[1]+"_"+ SD3[2]+" 08 PM.xls");
						try{
				       FileInputStream file5 = new FileInputStream("C:/DailyXLReports/"+SD3[2]+"/"+SD3[1]+"/"+L_W_Date3+"/Report_"+SD3[0]+"_"+ SD3[1]+"_"+ SD3[2]+" 08 PM.xls");
						Workbook wb5 = Workbook.getWorkbook(file5);
						Sheet sheet5 = wb5.getSheet("Results");
						R8_First5=sheet5.getCell(0, 1).getContents();
						R8_Second5=sheet5.getCell(0, 2).getContents();
						System.out.println(R8_First5);
						System.out.println(R8_Second5);
						}
						 catch(Exception e){
							 R8_First5=NA;
							 R8_Second5=NA;
						...
						Workbook wb5_y = Workbook.getWorkbook(file5_y);
						Sheet sheet5_y = wb5_y.getSheet("Results");
						R8_First5_y=sheet5_y.getCell(0, 1).getContents();
						System.out.println(R8_First5_y);
						} catch(Exception e){
							R8_First5_y=NA;
		    	            }
						
						//5 weeks back 8:30PM Report
						Calendar cal4 = Calendar.getInstance();
						DateFormat lastweek_5 = new SimpleDateFormat("dd_MMM_yyyy");
				        cal4.add(Calendar.DATE, -35);
				        Date TO5 = cal4.getTime();
				       ...
				       System.out.println("lastDates  is "+L_W_Date4);
				       System.out.println("C:/DailyXLReports/"+SD4[2]+"/"+SD4[1]+"/"+L_W_Date4+"/Report_"+SD4[0]+"_"+SD4[1]+"_"+ SD4[2]+" 08 PM.xls");
						try{
				       FileInputStream file6 = new FileInputStream("C:/DailyXLReports/"+SD4[2]+"/"+SD4[1]+"/"+L_W_Date4+"/Report_"+SD4[0]+"_"+ SD4[1]+"_"+ SD4[2]+" 08 PM.xls");
						Workbook wb6 = Workbook.getWorkbook(file6);
						Sheet sheet6 = wb6.getSheet("Results");
						R8_First6=sheet6.getCell(0, 1).getContents();
						R8_Second6=sheet6.getCell(0, 2).getContents();
						System.out.println(R8_First6);
						System.out.println(R8_Second6);
						}catch(Exception e){
							R8_First6=NA;
							R8_Second6=NA;
	    	            }
						...
						Workbook wb6_y = Workbook.getWorkbook(file6_y);
						Sheet sheet6_y = wb6_y.getSheet("Results");
						R8_First6_y=sheet6_y.getCell(0, 1).getContents();
						System.out.println(R8_First6_y);
						}
						catch(Exception e){
							R8_First6_y=NA;
							  }
						
						//6 weeks back 8:30PM Report
						Calendar cal5 = Calendar.getInstance();
						DateFormat lastweek_6 = new SimpleDateFormat("dd_MMM_yyyy");
				        cal5.add(Calendar.DATE, -42);
				        Date TO6 = cal5.getTime();
				       ...
				       System.out.println("lastDates  is "+L_W_Date5);
				       System.out.println("C:/DailyXLReports/"+SD5[2]+"/"+SD5[1]+"/"+L_W_Date5+"/Report_"+SD5[0]+"_"+SD5[1]+"_"+ SD5[2]+" 08 PM.xls");
						try{
				       FileInputStream file7 = new FileInputStream("C:/DailyXLReports/"+SD5[2]+"/"+SD5[1]+"/"+L_W_Date5+"/Report_"+SD5[0]+"_"+ SD5[1]+"_"+ SD5[2]+" 08 PM.xls");
						Workbook wb7 = Workbook.getWorkbook(file7);
						Sheet sheet7 = wb7.getSheet("Results");
						R8_First7=sheet7.getCell(0, 1).getContents();
						R8_Second7=sheet7.getCell(0, 2).getContents();
						System.out.println(R8_First7);
						System.out.println(R8_Second7);
						}
						catch(Exception e){
							R8_First7=NA;
							R8_Second7=NA;
						...
						Workbook wb7_y = Workbook.getWorkbook(file7_y);
						Sheet sheet7_y = wb7_y.getSheet("Results");
						R8_First7_y=sheet7_y.getCell(0, 1).getContents();
						System.out.println(R8_First7_y);
						}
						catch(Exception e){
							R8_First7_y=NA;
	...
	public static void Report_6_30PM() throws Exception
	{
		
		//To day 6:30PM Report
				DateFormat Formate_10 = new SimpleDateFormat("dd_MMM_yyyy");
				Date d_10 = new Date();
				System.out.println(Formate_10.format(d_10));
				String ToDay_10 = Formate_10.format(d_10);
				R6_toDayDate = ToDay_10.replace("_", "-");
				System.out.println(R6_toDayDate);
				String[] SD_10 = ToDay_10.split("_");
				System.out.println("Split the Date::" + SD_10[0]);
				System.out.println("Split the month::" + SD_10[1]);
				System.out.println("Split the Year::" + SD_10[2]);
				System.out.println("C:/DailyXLReports/"+SD_10[2]+"/"+SD_10[1]+"/"+ToDay_10+"/Report_"+SD_10[0]+"_"+SD_10[1]+"_"+ SD_10[2]+" 06 PM.xls");
				
				System.out.println("naga");
				try{
					
				
				FileInputStream file1 = new FileInputStream("C:/DailyXLReports/"+SD_10[2]+"/"+SD_10[1]+"/"+ToDay_10+"/Report_"+SD_10[0]+"_"+ SD_10[1]+"_"+ SD_10[2]+" 06 PM.xls");
				Workbook wb1 = Workbook.getWorkbook(file1);
				Sheet sheet1 = wb1.getSheet("Results");
				R6_First1=sheet1.getCell(0, 1).getContents();
				R6_Second1=sheet1.getCell(0, 2).getContents();
				System.out.println(R6_First1);
				System.out.println(R6_Second1);
				}
				catch(Exception e){
		       ...
		       System.out.println("lastDates  is "+LDate1);
		       System.out.println("C:/DailyXLReports/"+SD[2]+"/"+SD[1]+"/"+LDate1+"/Report_"+SD[0]+"_"+SD[1]+"_"+ SD[2]+" 06 PM.xls");
				try{
		       FileInputStream file2 = new FileInputStream("C:/DailyXLReports/"+SD[2]+"/"+SD[1]+"/"+LDate1+"/Report_"+SD[0]+"_"+ SD[1]+"_"+ SD[2]+" 06 PM.xls");
				Workbook wb2 = Workbook.getWorkbook(file2);
				Sheet sheet2 = wb2.getSheet("Results");
				
				R6_First2=sheet2.getCell(0, 1).getContents();
				R6_Second2=sheet2.getCell(0, 2).getContents();
				System.out.println(R6_First2);
				System.out.println(R6_Second2);
				}
                catch(Exception e){
				...
				Workbook wb2_y = Workbook.getWorkbook(file2_y);
				Sheet sheet2_y = wb2_y.getSheet("Results");
				R6_First2_y=sheet2_y.getCell(0, 1).getContents();
				System.out.println(R6_First2_y);
				}
                 catch(Exception e){
                	 R6_First2_y=NA;
				...
				//2 weeks back 6:30PM Report
				       ...
				       System.out.println("lastDates  is "+L_W_Date1);
				       System.out.println("C:/DailyXLReports/"+SD1[2]+"/"+SD1[1]+"/"+L_W_Date1+"/Report_"+SD1[0]+"_"+SD1[1]+"_"+ SD1[2]+" 06 PM.xls");
						try{
				       FileInputStream file3 = new FileInputStream("C:/DailyXLReports/"+SD1[2]+"/"+SD1[1]+"/"+L_W_Date1+"/Report_"+SD1[0]+"_"+ SD1[1]+"_"+ SD1[2]+" 06 PM.xls");
						Workbook wb3 = Workbook.getWorkbook(file3);
						Sheet sheet3 = wb3.getSheet("Results");
						
						R6_First3=sheet3.getCell(0, 1).getContents();
						R6_Second3=sheet3.getCell(0, 2).getContents();
						System.out.println(R6_First3);
						System.out.println(R6_Second3);
						}
						 catch(Exception e){
							 R6_First3=NA;
							 R6_Second3=NA;
						...
						Workbook wb3_y = Workbook.getWorkbook(file3_y);
						Sheet sheet3_y = wb3_y.getSheet("Results");
						R6_First3_y=sheet3_y.getCell(0, 1).getContents();
						System.out.println(R6_First3_y);
						}
	            	...
	            	R6_First3_y=NA;
				       ...
				       System.out.println("lastDates  is "+L_W_Date2);
				       System.out.println("C:/DailyXLReports/"+SD2[2]+"/"+SD2[1]+"/"+L_W_Date2+"/Report_"+SD2[0]+"_"+SD2[1]+"_"+ SD2[2]+" 06 PM.xls");
						
				       try{
				    	 FileInputStream file4 = new FileInputStream("C:/DailyXLReports/"+SD2[2]+"/"+SD2[1]+"/"+L_W_Date2+"/Report_"+SD2[0]+"_"+ SD2[1]+"_"+ SD2[2]+" 06 PM.xls");
				       	Workbook wb4 = Workbook.getWorkbook(file4);
						Sheet sheet4 = wb4.getSheet("Results");
						R6_First4=sheet4.getCell(0, 1).getContents();
						R6_Second4=sheet4.getCell(0, 2).getContents();
						System.out.println(R6_First4);
						System.out.println(R6_Second4);
				       }
				       catch(Exception e){
				    	   R6_First4=NA;
				    	   R6_Second4=NA;
				       ...
				       try{
						...
						Workbook wb4_y = Workbook.getWorkbook(file4_y);
						Sheet sheet4_y = wb4_y.getSheet("Results");
						R6_First4_y=sheet4_y.getCell(0, 1).getContents();
						System.out.println(R6_First4_y);
				       }
				       catch(Exception e){
				    	   R6_First4_y=NA;
				       ...
				       System.out.println("lastDates  is "+L_W_Date3);
				       System.out.println("C:/DailyXLReports/"+SD3[2]+"/"+SD3[1]+"/"+L_W_Date3+"/Report_"+SD3[0]+"_"+SD3[1]+"_"+ SD3[2]+" 06 PM.xls");
						try{
				       FileInputStream file5 = new FileInputStream("C:/DailyXLReports/"+SD3[2]+"/"+SD3[1]+"/"+L_W_Date3+"/Report_"+SD3[0]+"_"+ SD3[1]+"_"+ SD3[2]+" 06 PM.xls");
						Workbook wb5 = Workbook.getWorkbook(file5);
						Sheet sheet5 = wb5.getSheet("Results");
						R6_First5=sheet5.getCell(0, 1).getContents();
						R6_Second5=sheet5.getCell(0, 2).getContents();
						System.out.println(R6_First5);
						System.out.println(R6_Second5);
						}
						 catch(Exception e){
							 R6_First5=NA;
							 R6_Second5=NA;
						...
						Workbook wb5_y = Workbook.getWorkbook(file5_y);
						Sheet sheet5_y = wb5_y.getSheet("Results");
						R6_First5_y=sheet5_y.getCell(0, 1).getContents();
						System.out.println(R6_First5_y);
						} catch(Exception e){
							R6_First5_y=NA;
		    	            }
						
						//5 weeks back 6:30PM Report
						Calendar cal4 = Calendar.getInstance();
						DateFormat lastweek_5 = new SimpleDateFormat("dd_MMM_yyyy");
				        cal4.add(Calendar.DATE, -35);
				        Date TO5 = cal4.getTime();
				       ...
				       System.out.println("lastDates  is "+L_W_Date4);
				       System.out.println("C:/DailyXLReports/"+SD4[2]+"/"+SD4[1]+"/"+L_W_Date4+"/Report_"+SD4[0]+"_"+SD4[1]+"_"+ SD4[2]+" 06 PM.xls");
						try{
				       FileInputStream file6 = new FileInputStream("C:/DailyXLReports/"+SD4[2]+"/"+SD4[1]+"/"+L_W_Date4+"/Report_"+SD4[0]+"_"+ SD4[1]+"_"+ SD4[2]+" 06 PM.xls");
						Workbook wb6 = Workbook.getWorkbook(file6);
						Sheet sheet6 = wb6.getSheet("Results");
						R6_First6=sheet6.getCell(0, 1).getContents();
						R6_Second6=sheet6.getCell(0, 2).getContents();
						System.out.println(R6_First6);
						System.out.println(R6_Second6);
						}catch(Exception e){
							R6_First6=NA;
							R6_Second6=NA;
	    	            }
						...
						Workbook wb6_y = Workbook.getWorkbook(file6_y);
						Sheet sheet6_y = wb6_y.getSheet("Results");
						R6_First6_y=sheet6_y.getCell(0, 1).getContents();
						System.out.println(R6_First6_y);
						}
						catch(Exception e){
							R6_First6_y=NA;
							  }
						
						//6 weeks back 6:30PM Report
						Calendar cal5 = Calendar.getInstance();
						DateFormat lastweek_6 = new SimpleDateFormat("dd_MMM_yyyy");
				        cal5.add(Calendar.DATE, -42);
				        Date TO6 = cal5.getTime();
				       ...
				       System.out.println("lastDates  is "+L_W_Date5);
				       System.out.println("C:/DailyXLReports/"+SD5[2]+"/"+SD5[1]+"/"+L_W_Date5+"/Report_"+SD5[0]+"_"+SD5[1]+"_"+ SD5[2]+" 06 PM.xls");
						try{
				       FileInputStream file7 = new FileInputStream("C:/DailyXLReports/"+SD5[2]+"/"+SD5[1]+"/"+L_W_Date5+"/Report_"+SD5[0]+"_"+ SD5[1]+"_"+ SD5[2]+" 06 PM.xls");
						Workbook wb7 = Workbook.getWorkbook(file7);
						Sheet sheet7 = wb7.getSheet("Results");
						R6_First7=sheet7.getCell(0, 1).getContents();
						R6_Second7=sheet7.getCell(0, 2).getContents();
						System.out.println(R6_First7);
						System.out.println(R6_Second7);
						}
						catch(Exception e){
							R6_First7=NA;
							R6_Second7=NA;
						...
						Workbook wb7_y = Workbook.getWorkbook(file7_y);
						Sheet sheet7_y = wb7_y.getSheet("Results");
						R6_First7_y=sheet7_y.getCell(0, 1).getContents();
						System.out.println(R6_First7_y);
						}
						catch(Exception e){
							R6_First7_y=NA;
	...
	public static void Report_4_30PM() throws Exception
	{
		
		//To day 4:30PM Report
				DateFormat Formate_10 = new SimpleDateFormat("dd_MMM_yyyy");
				Date d_10 = new Date();
				System.out.println(Formate_10.format(d_10));
				String ToDay_10 = Formate_10.format(d_10);
				R4_toDayDate = ToDay_10.replace("_", "-");
				System.out.println(R4_toDayDate);
				String[] SD_10 = ToDay_10.split("_");
				System.out.println("Split the Date::" + SD_10[0]);
				System.out.println("Split the month::" + SD_10[1]);
				System.out.println("Split the Year::" + SD_10[2]);
				System.out.println("C:/DailyXLReports/"+SD_10[2]+"/"+SD_10[1]+"/"+ToDay_10+"/Report_"+SD_10[0]+"_"+SD_10[1]+"_"+ SD_10[2]+" 04 PM.xls");
				
				System.out.println("naga");
				try{
					
				
				FileInputStream file1 = new FileInputStream("C:/DailyXLReports/"+SD_10[2]+"/"+SD_10[1]+"/"+ToDay_10+"/Report_"+SD_10[0]+"_"+ SD_10[1]+"_"+ SD_10[2]+" 04 PM.xls");
				Workbook wb1 = Workbook.getWorkbook(file1);
				Sheet sheet1 = wb1.getSheet("Results");
				R4_First1=sheet1.getCell(0, 1).getContents();
				R4_Second1=sheet1.getCell(0, 2).getContents();
				System.out.println(R4_First1);
				System.out.println(R4_Second1);
				}
				catch(Exception e){
		       ...
		       System.out.println("lastDates  is "+LDate1);
		       System.out.println("C:/DailyXLReports/"+SD[2]+"/"+SD[1]+"/"+LDate1+"/Report_"+SD[0]+"_"+SD[1]+"_"+ SD[2]+" 04 PM.xls");
				try{
		       FileInputStream file2 = new FileInputStream("C:/DailyXLReports/"+SD[2]+"/"+SD[1]+"/"+LDate1+"/Report_"+SD[0]+"_"+ SD[1]+"_"+ SD[2]+" 04 PM.xls");
				Workbook wb2 = Workbook.getWorkbook(file2);
				Sheet sheet2 = wb2.getSheet("Results");
				
				R4_First2=sheet2.getCell(0, 1).getContents();
				R4_Second2=sheet2.getCell(0, 2).getContents();
				System.out.println(R4_First2);
				System.out.println(R4_Second2);
				}
                catch(Exception e){
				...
				Workbook wb2_y = Workbook.getWorkbook(file2_y);
				Sheet sheet2_y = wb2_y.getSheet("Results");
				R4_First2_y=sheet2_y.getCell(0, 1).getContents();
				System.out.println(R4_First2_y);
				}
                 catch(Exception e){
                	 R4_First2_y=NA;
				...
				//2 weeks back 4:30PM Report
				       ...
				       System.out.println("lastDates  is "+L_W_Date1);
				       System.out.println("C:/DailyXLReports/"+SD1[2]+"/"+SD1[1]+"/"+L_W_Date1+"/Report_"+SD1[0]+"_"+SD1[1]+"_"+ SD1[2]+" 04 PM.xls");
						try{
				       FileInputStream file3 = new FileInputStream("C:/DailyXLReports/"+SD1[2]+"/"+SD1[1]+"/"+L_W_Date1+"/Report_"+SD1[0]+"_"+ SD1[1]+"_"+ SD1[2]+" 04 PM.xls");
						Workbook wb3 = Workbook.getWorkbook(file3);
						Sheet sheet3 = wb3.getSheet("Results");
						
						R4_First3=sheet3.getCell(0, 1).getContents();
						R4_Second3=sheet3.getCell(0, 2).getContents();
						System.out.println(R4_First3);
						System.out.println(R4_Second3);
						}
						 catch(Exception e){
							 R4_First3=NA;
							 R4_Second3=NA;
						...
						Workbook wb3_y = Workbook.getWorkbook(file3_y);
						Sheet sheet3_y = wb3_y.getSheet("Results");
						R4_First3_y=sheet3_y.getCell(0, 1).getContents();
						System.out.println(R4_First3_y);
						}
	            	...
	            	R4_First3_y=NA;
				       ...
				       System.out.println("lastDates  is "+L_W_Date2);
				       System.out.println("C:/DailyXLReports/"+SD2[2]+"/"+SD2[1]+"/"+L_W_Date2+"/Report_"+SD2[0]+"_"+SD2[1]+"_"+ SD2[2]+" 04 PM.xls");
						
				       try{
				    	 FileInputStream file4 = new FileInputStream("C:/DailyXLReports/"+SD2[2]+"/"+SD2[1]+"/"+L_W_Date2+"/Report_"+SD2[0]+"_"+ SD2[1]+"_"+ SD2[2]+" 04 PM.xls");
				       	Workbook wb4 = Workbook.getWorkbook(file4);
						Sheet sheet4 = wb4.getSheet("Results");
						R4_First4=sheet4.getCell(0, 1).getContents();
						R4_Second4=sheet4.getCell(0, 2).getContents();
						System.out.println(R4_First4);
						System.out.println(R4_Second4);
				       }
				       catch(Exception e){
				    	   R4_First4=NA;
				    	   R4_Second4=NA;
				       ...
				       try{
						...
						Workbook wb4_y = Workbook.getWorkbook(file4_y);
						Sheet sheet4_y = wb4_y.getSheet("Results");
						R4_First4_y=sheet4_y.getCell(0, 1).getContents();
						System.out.println(R4_First4_y);
				       }
				       catch(Exception e){
				    	   R4_First4_y=NA;
				       ...
				       System.out.println("lastDates  is "+L_W_Date3);
				       System.out.println("C:/DailyXLReports/"+SD3[2]+"/"+SD3[1]+"/"+L_W_Date3+"/Report_"+SD3[0]+"_"+SD3[1]+"_"+ SD3[2]+" 04 PM.xls");
						try{
				       FileInputStream file5 = new FileInputStream("C:/DailyXLReports/"+SD3[2]+"/"+SD3[1]+"/"+L_W_Date3+"/Report_"+SD3[0]+"_"+ SD3[1]+"_"+ SD3[2]+" 04 PM.xls");
						Workbook wb5 = Workbook.getWorkbook(file5);
						Sheet sheet5 = wb5.getSheet("Results");
						R4_First5=sheet5.getCell(0, 1).getContents();
						R4_Second5=sheet5.getCell(0, 2).getContents();
						System.out.println(R4_First5);
						System.out.println(R4_Second5);
						}
						 catch(Exception e){
							 R4_First5=NA;
							 R4_Second5=NA;
						...
						Workbook wb5_y = Workbook.getWorkbook(file5_y);
						Sheet sheet5_y = wb5_y.getSheet("Results");
						R4_First5_y=sheet5_y.getCell(0, 1).getContents();
						System.out.println(R4_First5_y);
						} catch(Exception e){
							R4_First5_y=NA;
		    	            }
						
						//5 weeks back 4:30PM Report
						Calendar cal4 = Calendar.getInstance();
						DateFormat lastweek_5 = new SimpleDateFormat("dd_MMM_yyyy");
				        cal4.add(Calendar.DATE, -35);
				        Date TO5 = cal4.getTime();
				       ...
				       System.out.println("lastDates  is "+L_W_Date4);
				       System.out.println("C:/DailyXLReports/"+SD4[2]+"/"+SD4[1]+"/"+L_W_Date4+"/Report_"+SD4[0]+"_"+SD4[1]+"_"+ SD4[2]+" 04 PM.xls");
						try{
				       FileInputStream file6 = new FileInputStream("C:/DailyXLReports/"+SD4[2]+"/"+SD4[1]+"/"+L_W_Date4+"/Report_"+SD4[0]+"_"+ SD4[1]+"_"+ SD4[2]+" 04 PM.xls");
						Workbook wb6 = Workbook.getWorkbook(file6);
						Sheet sheet6 = wb6.getSheet("Results");
						R4_First6=sheet6.getCell(0, 1).getContents();
						R4_Second6=sheet6.getCell(0, 2).getContents();
						System.out.println(R4_First6);
						System.out.println(R4_Second6);
						}catch(Exception e){
							R4_First6=NA;
							R4_Second6=NA;
	    	            }
						...
						Workbook wb6_y = Workbook.getWorkbook(file6_y);
						Sheet sheet6_y = wb6_y.getSheet("Results");
						R4_First6_y=sheet6_y.getCell(0, 1).getContents();
						System.out.println(R4_First6_y);
						}
						catch(Exception e){
							R4_First6_y=NA;
							  }
						
						//6 weeks back 4:30PM Report
						Calendar cal5 = Calendar.getInstance();
						DateFormat lastweek_6 = new SimpleDateFormat("dd_MMM_yyyy");
				        cal5.add(Calendar.DATE, -42);
				        Date TO6 = cal5.getTime();
				       ...
				       System.out.println("lastDates  is "+L_W_Date5);
				       System.out.println("C:/DailyXLReports/"+SD5[2]+"/"+SD5[1]+"/"+L_W_Date5+"/Report_"+SD5[0]+"_"+SD5[1]+"_"+ SD5[2]+" 04 PM.xls");
						try{
				       FileInputStream file7 = new FileInputStream("C:/DailyXLReports/"+SD5[2]+"/"+SD5[1]+"/"+L_W_Date5+"/Report_"+SD5[0]+"_"+ SD5[1]+"_"+ SD5[2]+" 04 PM.xls");
						Workbook wb7 = Workbook.getWorkbook(file7);
						Sheet sheet7 = wb7.getSheet("Results");
						R4_First7=sheet7.getCell(0, 1).getContents();
						R4_Second7=sheet7.getCell(0, 2).getContents();
						System.out.println(R4_First7);
						System.out.println(R4_Second7);
						}
						catch(Exception e){
							R4_First7=NA;
							R4_Second7=NA;
						...
						Workbook wb7_y = Workbook.getWorkbook(file7_y);
						Sheet sheet7_y = wb7_y.getSheet("Results");
						R4_First7_y=sheet7_y.getCell(0, 1).getContents();
						System.out.println(R4_First7_y);
						}
						catch(Exception e){
							R4_First7_y=NA;
	...
	public static void deviation_Report_10PM()
	{
		//To day 10:30PM Report
		DateFormat Formate_10 = new SimpleDateFormat("dd_MMM_yyyy");
		Date d_10 = new Date();
		...
		try{
			...
			differentPageReports.deviation_Report_Today("C:/DailyXLReports/"+SD_10[2]+"/"+SD_10[1]+"/"+ToDay_10+"/Report_"+SD_10[0]+"_"+SD_10[1]+"_"+ SD_10[2]+" 10 PM.xls",4,5,6,7);
       ...
       System.out.println("C:/DailyXLReports/"+SD[2]+"/"+SD[1]+"/"+LDate1+"/Report_"+SD[0]+"_"+SD[1]+"_"+ SD[2]+" 10 PM.xls");
		try{
			differentPageReports.deviation_Report_Lastweek("C:/DailyXLReports/"+SD[2]+"/"+SD[1]+"/"+LDate1+"/Report_"+SD[0]+"_"+ SD[1]+"_"+ SD[2]+" 10 PM.xls", 4, 5, 6, 7);
	...
	public static void SoldOutPercentage_Report()
	{
		...
		System.out.println("naga");
		try{
			differentPageReports.SoldOut_Percentage("C:/DailyXLReports/"+SD_10[2]+"/"+SD_10[1]+"/"+ToDay_10+"/Report_"+SD_10[0]+"_"+SD_10[1]+"_"+ SD_10[2]+" 10 PM.xls",9,10,11,12);
	...
	public static void html_table_for_10PM() throws EmailException
	{
		...
		int R4_f1=Integer.parseInt(R4_First1)+Integer.parseInt(R4_Second1);
		int R4_f2=Integer.parseInt(R4_First2)+Integer.parseInt(R4_Second2);
		int R4_f3=Integer.parseInt(R4_First3)+Integer.parseInt(R4_Second3);
		int R4_f4=Integer.parseInt(R4_First4)+Integer.parseInt(R4_Second4);
		int R4_f5=Integer.parseInt(R4_First5)+Integer.parseInt(R4_Second5);
		int R4_f6=Integer.parseInt(R4_First6)+Integer.parseInt(R4_Second6);
		int R4_f7=Integer.parseInt(R4_First7)+Integer.parseInt(R4_Second7);
		
		int R6_f1=Integer.parseInt(R6_First1)+Integer.parseInt(R6_Second1);
		int R6_f2=Integer.parseInt(R6_First2)+Integer.parseInt(R6_Second2);
		int R6_f3=Integer.parseInt(R6_First3)+Integer.parseInt(R6_Second3);
		int R6_f4=Integer.parseInt(R6_First4)+Integer.parseInt(R6_Second4);
		int R6_f5=Integer.parseInt(R6_First5)+Integer.parseInt(R6_Second5);
		int R6_f6=Integer.parseInt(R6_First6)+Integer.parseInt(R6_Second6);
		int R6_f7=Integer.parseInt(R6_First7)+Integer.parseInt(R6_Second7);
		
		int R8_f1=Integer.parseInt(R8_First1)+Integer.parseInt(R8_Second1);
		int R8_f2=Integer.parseInt(R8_First2)+Integer.parseInt(R8_Second2);
		int R8_f3=Integer.parseInt(R8_First3)+Integer.parseInt(R8_Second3);
		int R8_f4=Integer.parseInt(R8_First4)+Integer.parseInt(R8_Second4);
		int R8_f5=Integer.parseInt(R8_First5)+Integer.parseInt(R8_Second5);
		int R8_f6=Integer.parseInt(R8_First6)+Integer.parseInt(R8_Second6);
		int R8_f7=Integer.parseInt(R8_First7)+Integer.parseInt(R8_Second7);
		
		int R10PM_f1=Integer.parseInt(R10PM_First1)+Integer.parseInt(R10PM_Second1);
		int R10PM_f2=Integer.parseInt(R10PM_First2)+Integer.parseInt(R10PM_Second2);
		int R10PM_f3=Integer.parseInt(R10PM_First3)+Integer.parseInt(R10PM_Second3);
		int R10PM_f4=Integer.parseInt(R10PM_First4)+Integer.parseInt(R10PM_Second4);
		int R10PM_f5=Integer.parseInt(R10PM_First5)+Integer.parseInt(R10PM_Second5);
		int R10PM_f6=Integer.parseInt(R10PM_First6)+Integer.parseInt(R10PM_Second6);
		int R10PM_f7=Integer.parseInt(R10PM_First7)+Integer.parseInt(R10PM_Second7);
	 ...
	 int R4_L1=R4_f1-R4_f2;
	 int R4_L2=R4_f1-R4_f3;
	 int R4_L3=R4_f1-R4_f4;
	 int R4_L4=R4_f1-R4_f5;
	 int R4_L5=R4_f1-R4_f6;
	 int R4_L6=R4_f1-R4_f7;
	 String R4_neg1;
	 String R4_neg2;
	 String R4_neg3;
	 String R4_neg4;
	 ...
	 int R6_L1=R6_f1-R6_f2;
	 int R6_L2=R6_f1-R6_f3;
	 int R6_L3=R6_f1-R6_f4;
	 int R6_L4=R6_f1-R6_f5;
	 int R6_L5=R6_f1-R6_f6;
	 int R6_L6=R6_f1-R6_f7;
	 String R6_neg1;
	 String R6_neg2;
	 String R6_neg3;
	 String R6_neg4;
	 ...
	 int R8_L1=R8_f1-R8_f2;
	 int R8_L2=R8_f1-R8_f3;
	 int R8_L3=R8_f1-R8_f4;
	 int R8_L4=R8_f1-R8_f5;
	 int R8_L5=R8_f1-R8_f6;
	 int R8_L6=R8_f1-R8_f7;
	 String R8_neg1;
	 String R8_neg2;
	 String R8_neg3;
	 String R8_neg4;
	 ...
	 int R10PM_L1=R10PM_f1-R10PM_f2;
	 int R10PM_L2=R10PM_f1-R10PM_f3;
	 int R10PM_L3=R10PM_f1-R10PM_f4;
	 int R10PM_L4=R10PM_f1-R10PM_f5;
	 int R10PM_L5=R10PM_f1-R10PM_f6;
	 int R10PM_L6=R10PM_f1-R10PM_f7;
	 String R10PM_neg1;
	 String R10PM_neg2;
	 String R10PM_neg3;
	 String R10PM_neg4;
	 ...
	 else
	 {
		...
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr>Please find the Flights Booking Status Difference Report @10:30 PM <tr>"));
		...
		*/
		...
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr>10:30PM<tr>"));
		...
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr align=center bgcolor= #BB8FCE class=table table-bordered style=border-color:black><td>Total Bookings</td><td>NA</td> <td>"+R10PM_First7_y+"</td><td>"+R10PM_First6_y+"</td><td>"+R10PM_First5_y+"</td><td>"+R10PM_First4_y+"</td><td>"+R10PM_First3_y+"</td><td>"+R10PM_First2_y+"</td></tr>"));
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr align=center bgcolor= #FFFFFF class=table table-bordered style=border-color:black><td>TXNS</td><td>"+R10PM_First1+"</td> <td>"+R10PM_First7+"</td><td>"+R10PM_First6+"</td><td>"+R10PM_First5+"</td><td>"+R10PM_First4+"</td><td>"+R10PM_First3+"</td><td>"+R10PM_First2+"</td></tr>"));
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr align=center bgcolor= #FFFFFF class=table table-bordered style=border-color:black><td>REPR</td><td>"+R10PM_Second1+"</td> <td>"+R10PM_Second7+"</td><td>"+R10PM_Second6+"</td><td>"+R10PM_Second5+"</td><td>"+R10PM_Second4+"</td><td>"+R10PM_Second3+"</td><td>"+R10PM_Second2+"</td></tr>"));
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr align=center bgcolor= #ffa500 class=table table-bordered style=border-color:black><td>Running Total</td><td>"+R10PM_f1+"</td> <td>"+R10PM_f7+"</td><td>"+R10PM_f6+"</td><td>"+R10PM_f5+"</td><td>"+R10PM_f4+"</td><td>"+R10PM_f3+"</td><td>"+R10PM_f2+"</td></tr>"));
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr align=center bgcolor= #2ECC71 class=table table-bordered style=border-color:black><td>Leading</td><td> </td> <td bgcolor="+R10PM_neg6+">"+R10PM_L6+"</td><td bgcolor="+R10PM_neg5+">"+R10PM_L5+"</td><td bgcolor="+R10PM_neg4+">"+R10PM_L4+"</td><td bgcolor="+R10PM_neg3+">"+R10PM_L3+"</td><td bgcolor="+R10PM_neg2+">"+R10PM_L2+"</td><td bgcolor="+R10PM_neg1+">"+R10PM_L1+"</td></tr>"));
		...
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr> <tr>"));
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr> <tr>"));
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr>8:30PM<tr>"));
		email.setHtmlMsg(""+htmlStringBuilder.append(" <table width = 800 height = 150 cellpadding=5 border=1 cellspacing=5 style=font-size:12px;border-collapse:collapse; border-style: solid;border-spacing: 2px; border-width: thin;text-align:center > <tr align=center bgcolor=#18bcf2 class=m_-7593383128584549858table style=color:#ffffff><th> </th><th>"+toDayDate+"</th> <th>"+toDayDate6+"</th> <th>"+toDayDate5+"</th><th>"+toDayDate4+"</th><th>"+toDayDate3+"</th> <th>"+toDayDate2+"</th> <th>"+toDayDate1+"</th> </tr> "));

			
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr align=center bgcolor= #BB8FCE class=table table-bordered style=border-color:black><td>Total Bookings</td><td>NA</td> <td>"+R8_First7_y+"</td><td>"+R8_First6_y+"</td><td>"+R8_First5_y+"</td><td>"+R8_First4_y+"</td><td>"+R8_First3_y+"</td><td>"+R8_First2_y+"</td></tr>"));
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr align=center bgcolor= #FFFFFF class=table table-bordered style=border-color:black><td>TXNS</td><td>"+R8_First1+"</td> <td>"+R8_First7+"</td><td>"+R8_First6+"</td><td>"+R8_First5+"</td><td>"+R8_First4+"</td><td>"+R8_First3+"</td><td>"+R8_First2+"</td></tr>"));
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr align=center bgcolor= #FFFFFF class=table table-bordered style=border-color:black><td>REPR</td><td>"+R8_Second1+"</td> <td>"+R8_Second7+"</td><td>"+R8_Second6+"</td><td>"+R8_Second5+"</td><td>"+R8_Second4+"</td><td>"+R8_Second3+"</td><td>"+R8_Second2+"</td></tr>"));
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr align=center bgcolor= #ffa500 class=table table-bordered style=border-color:black><td>Running Total</td><td>"+R8_f1+"</td> <td>"+R8_f7+"</td><td>"+R8_f6+"</td><td>"+R8_f5+"</td><td>"+R8_f4+"</td><td>"+R8_f3+"</td><td>"+R8_f2+"</td></tr>"));
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr align=center bgcolor= #2ECC71 class=table table-bordered style=border-color:black><td>Leading</td><td> </td> <td bgcolor="+R8_neg6+">"+R8_L6+"</td><td bgcolor="+R8_neg5+">"+R8_L5+"</td><td bgcolor="+R8_neg4+">"+R8_L4+"</td><td bgcolor="+R8_neg3+">"+R8_L3+"</td><td bgcolor="+R8_neg2+">"+R8_L2+"</td><td bgcolor="+R8_neg1+">"+R8_L1+"</td></tr>"));
		...
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr> <tr>"));
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr> <tr>"));
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr>6:30PM<tr>"));
		email.setHtmlMsg(""+htmlStringBuilder.append(" <table width = 800 height = 150 cellpadding=5 border=1 cellspacing=5 style=font-size:12px;border-collapse:collapse; border-style: solid;border-spacing: 2px; border-width: thin;text-align:center > <tr align=center bgcolor=#18bcf2 class=m_-7593383128584549858table style=color:#ffffff><th> </th><th>"+toDayDate+"</th> <th>"+toDayDate6+"</th> <th>"+toDayDate5+"</th><th>"+toDayDate4+"</th><th>"+toDayDate3+"</th> <th>"+toDayDate2+"</th> <th>"+toDayDate1+"</th> </tr> "));

			
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr align=center bgcolor= #BB8FCE class=table table-bordered style=border-color:black><td>Total Bookings</td><td>NA</td> <td>"+R6_First7_y+"</td><td>"+R6_First6_y+"</td><td>"+R6_First5_y+"</td><td>"+R6_First4_y+"</td><td>"+R6_First3_y+"</td><td>"+R6_First2_y+"</td></tr>"));
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr align=center bgcolor= #FFFFFF class=table table-bordered style=border-color:black><td>TXNS</td><td>"+R6_First1+"</td> <td>"+R6_First7+"</td><td>"+R6_First6+"</td><td>"+R6_First5+"</td><td>"+R6_First4+"</td><td>"+R6_First3+"</td><td>"+R6_First2+"</td></tr>"));
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr align=center bgcolor= #FFFFFF class=table table-bordered style=border-color:black><td>REPR</td><td>"+R6_Second1+"</td> <td>"+R6_Second7+"</td><td>"+R6_Second6+"</td><td>"+R6_Second5+"</td><td>"+R6_Second4+"</td><td>"+R6_Second3+"</td><td>"+R6_Second2+"</td></tr>"));
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr align=center bgcolor= #ffa500 class=table table-bordered style=border-color:black><td>Running Total</td><td>"+R6_f1+"</td> <td>"+R6_f7+"</td><td>"+R6_f6+"</td><td>"+R6_f5+"</td><td>"+R6_f4+"</td><td>"+R6_f3+"</td><td>"+R6_f2+"</td></tr>"));
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr align=center bgcolor= #2ECC71 class=table table-bordered style=border-color:black><td>Leading</td><td> </td> <td bgcolor="+R6_neg6+">"+R6_L6+"</td><td bgcolor="+R6_neg5+">"+R6_L5+"</td><td bgcolor="+R6_neg4+">"+R6_L4+"</td><td bgcolor="+R6_neg3+">"+R6_L3+"</td><td bgcolor="+R6_neg2+">"+R6_L2+"</td><td bgcolor="+R6_neg1+">"+R6_L1+"</td></tr>"));
		...
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr> <tr>"));
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr> <tr>"));
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr>4:30PM<tr>"));
		email.setHtmlMsg(""+htmlStringBuilder.append(" <table width = 800 height = 150 cellpadding=5 border=1 cellspacing=5 style=font-size:12px;border-collapse:collapse; border-style: solid;border-spacing: 2px; border-width: thin;text-align:center > <tr align=center bgcolor=#18bcf2 class=m_-7593383128584549858table style=color:#ffffff><th> </th><th>"+toDayDate+"</th> <th>"+toDayDate6+"</th> <th>"+toDayDate5+"</th><th>"+toDayDate4+"</th><th>"+toDayDate3+"</th> <th>"+toDayDate2+"</th> <th>"+toDayDate1+"</th> </tr> "));

			
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr align=center bgcolor= #BB8FCE class=table table-bordered style=border-color:black><td>Total Bookings</td><td>NA</td> <td>"+R4_First7_y+"</td><td>"+R4_First6_y+"</td><td>"+R4_First5_y+"</td><td>"+R4_First4_y+"</td><td>"+R4_First3_y+"</td><td>"+R4_First2_y+"</td></tr>"));
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr align=center bgcolor= #FFFFFF class=table table-bordered style=border-color:black><td>TXNS</td><td>"+R4_First1+"</td> <td>"+R4_First7+"</td><td>"+R4_First6+"</td><td>"+R4_First5+"</td><td>"+R4_First4+"</td><td>"+R4_First3+"</td><td>"+R4_First2+"</td></tr>"));
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr align=center bgcolor= #FFFFFF class=table table-bordered style=border-color:black><td>REPR</td><td>"+R4_Second1+"</td> <td>"+R4_Second7+"</td><td>"+R4_Second6+"</td><td>"+R4_Second5+"</td><td>"+R4_Second4+"</td><td>"+R4_Second3+"</td><td>"+R4_Second2+"</td></tr>"));
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr align=center bgcolor= #ffa500 class=table table-bordered style=border-color:black><td>Running Total</td><td>"+R4_f1+"</td> <td>"+R4_f7+"</td><td>"+R4_f6+"</td><td>"+R4_f5+"</td><td>"+R4_f4+"</td><td>"+R4_f3+"</td><td>"+R4_f2+"</td></tr>"));
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr align=center bgcolor= #2ECC71 class=table table-bordered style=border-color:black><td>Leading</td><td> </td> <td bgcolor="+R4_neg6+">"+R4_L6+"</td><td bgcolor="+R4_neg5+">"+R4_L5+"</td><td bgcolor="+R4_neg4+">"+R4_L4+"</td><td bgcolor="+R4_neg3+">"+R4_L3+"</td><td bgcolor="+R4_neg2+">"+R4_L2+"</td><td bgcolor="+R4_neg1+">"+R4_L1+"</td></tr>"));
		...
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr> <tr>"));
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr> <tr>"));
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr>2:30 PM <tr>"));
        email.setHtmlMsg(""+htmlStringBuilder.append(" <table width = 800 height = 150 cellpadding=5 border=1 cellspacing=5 style=font-size:12px;border-collapse:collapse; border-style: solid;border-spacing: 2px; border-width: thin;text-align:center > <tr align=center bgcolor=#18bcf2 class=m_-7593383128584549858table style=color:#ffffff><th> </th><th>"+toDayDate+"</th> <th>"+toDayDate6+"</th> <th>"+toDayDate5+"</th><th>"+toDayDate4+"</th><th>"+toDayDate3+"</th> <th>"+toDayDate2+"</th> <th>"+toDayDate1+"</th> </tr> "));
		...
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr> <tr>"));
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr> <tr>"));
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr>12:30 PM <tr>"));
		email.setHtmlMsg(""+htmlStringBuilder.append(" <table width = 800 height = 150 cellpadding=5 border=1 cellspacing=5 style=font-size:12px;border-collapse:collapse; border-style: solid;border-spacing: 2px; border-width: thin;text-align:center > <tr align=center bgcolor=#18bcf2 class=m_-7593383128584549858table style=color:#ffffff><th> </th><th>"+toDayDate+"</th> <th>"+toDayDate6+"</th> <th>"+toDayDate5+"</th><th>"+toDayDate4+"</th><th>"+toDayDate3+"</th> <th>"+toDayDate2+"</th> <th>"+toDayDate1+"</th> </tr> "));
		...
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr> <tr>"));
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr> <tr>"));
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr>10:30 AM <tr>"));
		email.setHtmlMsg(""+htmlStringBuilder.append(" <table width = 800 height = 150 cellpadding=5 border=1 cellspacing=5 style=font-size:12px;border-collapse:collapse; border-style: solid;border-spacing: 2px; border-width: thin;text-align:center > <tr align=center bgcolor=#18bcf2 class=m_-7593383128584549858table style=color:#ffffff><th> </th><th>"+toDayDate+"</th> <th>"+toDayDate6+"</th> <th>"+toDayDate5+"</th><th>"+toDayDate4+"</th><th>"+toDayDate3+"</th> <th>"+toDayDate2+"</th> <th>"+toDayDate1+"</th> </tr> "));
		...
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr> <tr>"));
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr> <tr>"));
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr>8:30 AM <tr>"));
