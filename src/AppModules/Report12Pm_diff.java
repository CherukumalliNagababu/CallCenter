...
public class Report12Pm_diff extends differentPageReports {
	...
	public static void deviation_Report_12PM()
	{
		//To day 12:30PM Report
				DateFormat Formate_10 = new SimpleDateFormat("dd_MMM_yyyy");
				Date d_10 = new Date();
				System.out.println(Formate_10.format(d_10));
				String ToDay_10 = Formate_10.format(d_10);
				String R12_toDayDate1 = ToDay_10.replace("_", "-");
				System.out.println(R12_toDayDate1);
				String[] SD_10 = ToDay_10.split("_");
				System.out.println("Split the Date::" + SD_10[0]);
				System.out.println("Split the month::" + SD_10[1]);
				System.out.println("Split the Year::" + SD_10[2]);
				...
				System.out.println("naga");
				try{
					differentPageReports.deviation_Report_Today("C:/DailyXLReports/"+SD_10[2]+"/"+SD_10[1]+"/"+ToDay_10+"/Report_"+SD_10[0]+"_"+SD_10[1]+"_"+ SD_10[2]+" 12 PM.xls",4,5,6,7);
		       ...
		       try{
		    	   differentPageReports.deviation_Report_Lastweek("C:/DailyXLReports/"+SD[2]+"/"+SD[1]+"/"+LDate1+"/Report_"+SD[0]+"_"+ SD[1]+"_"+ SD[2]+" 12 PM.xls", 4, 5, 6, 7);
	...
	public static void SoldOutPercentage_Report()
	{
		...
		System.out.println("naga");
		try{
			differentPageReports.SoldOut_Percentage("C:/DailyXLReports/"+SD_10[2]+"/"+SD_10[1]+"/"+ToDay_10+"/Report_"+SD_10[0]+"_"+SD_10[1]+"_"+ SD_10[2]+" 12 PM.xls",9,10,11,12);
	...
	public static void html_table_for_12PM() throws EmailException
	{
	 ...
	 else
	 {
		...
		email.setHtmlMsg(""+htmlStringBuilder.append("<tr>Please find the Flights Booking Status Difference Report @12:30 PM <tr>"));
