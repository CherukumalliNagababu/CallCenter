...
public class TransactionSuccessful {
	 ...
	 */
	String extentReportFile = Constant.ExtentReports + "\\TransactionSuccessful\\extentReportFile.html";
	String extentReportImage = Constant.ExtentReports + "\\TransactionSuccessful\\extentReportImage.png";
	...
	public void testRoundTrip_Search() throws Exception {
		...
		try {
			...
			if (Constant.URL.equalsIgnoreCase("http://stagecallcenter.rehlat.com/")) {
				...
				BookingStatusSearch.TransactionSuccessful(iTestCaseRow,driver);
