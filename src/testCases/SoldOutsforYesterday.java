...
public class SoldOutsforYesterday {
	 ...
	 */
	String extentReportFile = Constant.ExtentReports + "\\SoldOutsforYesterday\\extentReportFile.html";
	String extentReportImage = Constant.ExtentReports + "\\SoldOutsforYesterday\\extentReportImage.png";
	...
	public void testRoundTrip_Search() throws Exception {
		...
		try {
			...
			if (Constant.URL.equalsIgnoreCase("http://stagecallcenter.rehlat.com/")) {
				...
				BookingStatusSearch.YesterdaySoldOuts(iTestCaseRow,driver);
