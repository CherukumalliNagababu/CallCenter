...
public class AllStatus_ReportsInTable {
	...
	public void testRoundTrip_Search() throws Exception {
		...
		try {
			...
			if (Constant.URL.equalsIgnoreCase("http://stagecallcenter.rehlat.com/")) {
				...
				AllStatus_tableView.Soldouts_com(iTestCaseRow, driver);
				AllStatus_tableView.Soldouts_Sa(iTestCaseRow, driver);
				AllStatus_tableView.Soldouts_AE(iTestCaseRow, driver);
				AllStatus_tableView.Soldouts_Eg(iTestCaseRow, driver);
				Mail.testmail(iTestCaseRow);
