...
import AppModules.NoBookings_All;
...
import AppModules.HtmlFormate_For_NoBookings;
...
public class NoBookings_All_Test {
	...
	@Test
	public void BookingStatus() throws Exception {
		...
		try {
			...
			if (Constant.URL.equalsIgnoreCase("http://stagecallcenter.rehlat.com/")) {
				...
				NoBookings_All.AllStatus_TS_SD_CN_TH_com(iTestCaseRow, driver);
				NoBookings_All.AllStatus_TS_SD_CN_TH_SA(iTestCaseRow, driver);
				NoBookings_All.AllStatus_TS_SD_CN_TH_AE(iTestCaseRow, driver);
				HtmlFormate_For_NoBookings.TestFormate(iTestCaseRow, driver);
